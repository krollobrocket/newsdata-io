    ...
    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <textarea maxlength="512" class="regular-text" name="<?php echo esc_attr(Arguments::ARG_QUERY); ?>" id="<?php echo esc_attr(Arguments::ARG_QUERY); ?>"><?php echo esc_textarea($this->settings->get(Arguments::ARG_QUERY)); ?></textarea>
            ...
            <tr>
                ...
                <td>
                    <textarea maxlength="512" class="regular-text" name="<?php echo esc_attr(Arguments::ARG_QUERY_TITLE); ?>" id="<?php echo esc_attr(Arguments::ARG_QUERY_TITLE); ?>"><?php echo esc_textarea($this->settings->get(Arguments::ARG_QUERY_TITLE)); ?></textarea>
            ...
            <tr>
                ...
                <td>
                    <textarea maxlength="512" class="regular-text" name="<?php echo esc_attr(Arguments::ARG_QUERY_META); ?>" id="<?php echo esc_attr(Arguments::ARG_QUERY_META); ?>"><?php echo esc_textarea($this->settings->get(Arguments::ARG_QUERY_META)); ?></textarea>
